...
namespace GENReportCreator
{
    public class GENReportCreator : iScheduler
    {
                        ...
                        else
                        {
                            ...
                            if (renderIt(xmlFolder + filename + ".xml", foFolder + report.reportTemplateName + ".xfd", outputFolder + filename + ".pdf"))
                            {
                                if (report.sfo_orderId != null)
                                {
                                    ...
                                    if (attach)
                                        Tc.TcMedia.Sfo.SFOBase.OrderAddAttachement(process, report.sfo_orderId, outputFolder + filename + ".pdf");
                                    else
