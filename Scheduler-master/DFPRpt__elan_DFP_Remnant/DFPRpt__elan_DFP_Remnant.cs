...
namespace DFPRpt__elan_DFP_Remnant
{
    public class DFPRpt__elan_DFP_Remnant : DFPRpt_base, iDFPReportDownloader
    {
        public void define(ReportConfig config, string timespan)
        {
            ...
            reportJob.reportQuery.statement.query = "where advertiser_id in (" + getRemnantAdvertiserIds(config) + ")";
